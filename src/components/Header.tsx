...
const Header = ({
  ...
  return <>
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <div className="ml-auto">
                  <NavigationMenu>
                    ...
                    <NavigationMenuItem>
                      <NavigationMenuLink className="text-xs px-3 py-1 hover:bg-white/10 rounded transition-colors" href="/categories">
                        ​Thématiques 
                      </NavigationMenuLink>
                    </NavigationMenuItem>
                    <NavigationMenuItem>
      ...
      <div className="container mx-auto bg-[#ff0000] px-px">
        <div className="flex items-center justify-between h-[30px] px-[16px] bg-accent">
