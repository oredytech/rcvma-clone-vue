  ...
  if (isMobile && isMinimized && isVisible) {
    return <>
        ...
        <div className="fixed bottom-[63px] right-4 z-40 animate-in slide-in-from-bottom-2">
          <Button size="sm" onClick={togglePlay} className="bg-primary hover:bg-primary/90 h-11 w-11 p-0 rounded-full shadow-lg opacity-85">
      ...
      <div className={`
        ...
        <div className="container mx-auto px-4 py-2">
          ...
          <div className="flex items-center gap-3">
            ...
            {isMobile && <Button size="sm" variant="ghost" onClick={() => setIsVisible(false)} className="h-9 w-9 p-0 hover:bg-white/10">
                <X className="h-4 w-4" />
              </Button>}
          </div>
          </div>
