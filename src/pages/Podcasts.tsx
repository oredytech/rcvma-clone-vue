          ...
          <ScrollArea className={`${isMobile ? 'h-[60vh]' : 'h-[calc(100vh-350px)]'}`}>
            <div className="grid gap-4">
              {episodes.map((episode, index) => (
                <div
                  key={index}
                  className={`bg-card border border-border rounded-lg p-4 hover:border-primary transition-all cursor-pointer ${
                    currentEpisode?.title === episode.title ? 'border-primary bg-primary/5' : ''
                  }`}
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <Button
                      size="icon"
                      variant={currentEpisode?.title === episode.title && isPlaying ? "default" : "outline"}
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    >
                      {currentEpisode?.title === episode.title && isPlaying ? (
          ...
          <div className="container mx-auto px-4 py-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-sm truncate text-foreground">{currentEpisode.title}</h4>
                <p className="text-xs text-muted-foreground truncate">OREDY MEDIA Podcast</p>
              </div>
