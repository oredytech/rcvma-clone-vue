        ...
        <div className="container mx-auto px-4 py-[4px]">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {activePlayer === 'podcast' && <Button size="sm" variant="ghost" onClick={skipBackward} className="h-8 w-8 p-0 hover:bg-white/10">
                  <SkipBack className="h-4 w-4" />
                </Button>}

              {/* Volume - masqué sur mobile */}
              {!isMobile && <div className="flex items-center gap-2 w-24">
              ...
              {activePlayer === 'podcast' && <Button size="sm" variant="ghost" onClick={skipForward} className="h-8 w-8 p-0 hover:bg-white/10">
                  <SkipForward className="h-4 w-4" />
                </Button>}

              {/* Bouton fermer - masqué sur desktop pour radio */}
              {(isMobile || activePlayer === 'podcast') && <Button size="sm" variant="ghost" onClick={closePlayer} className="h-9 w-9 p-0 hover:bg-white/10">
                  <X className="h-4 w-4" />
                </Button>}
            </div>
          </div>
